<div id="float_plate" class="row">
	...
	<div id="plate_overall_progress">
		...
		<div id="pop_value">
			<span class="set1" id="overall_actual">76%</span>
			<span class="set2" id="overall_early">78%</span>
			<span class="set3" id="overall_variance">-2w</span>
			<span class="set4"><i id="trend" aria-hidden="true"></i><span id="trend_text"></span></span>
		</div>
	</div>
