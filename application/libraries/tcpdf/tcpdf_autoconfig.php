...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'mrt_md.png')) {
		$tcpdf_header_logo = 'mrt_md.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'MRT Corp');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'MRT Corp');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'PROGRESS REPORT');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by mpxd,mrt.com.my");
}
